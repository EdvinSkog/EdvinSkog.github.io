...
/** @type {string} */
const CACHE_VERSION = '1765814879|5399730303';
/** @type {string} */
const CACHE_PREFIX = 'Portfolio OS-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Portfolio_OS.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Portfolio_OS.html","Portfolio_OS.js","Portfolio_OS.offline.html","Portfolio_OS.icon.png","Portfolio_OS.apple-touch-icon.png","Portfolio_OS.audio.worklet.js","Portfolio_OS.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Portfolio_OS.wasm","Portfolio_OS.pck"];
